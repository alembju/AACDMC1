...
const getPdf = async () => {
  const result = await axios.get(`${BASE_URL}/get-upload`);
...
const Upload= () => {
  ...
  const handleSubmit = (e) =>{
    ...
    console.log(Title,Title)
    axios.post(`${BASE_URL}/register`,{orgname,title,principal,phone,dsharing,availability,raw,coverage,BGDate,LDate,gender,type,cleaned,url,comments,email,Title})
  ...
  return (
    <><div><Header /></div><div className='d-flex BgcolorAdmin justify-content-center align-items-center vh-100'>
      <div className='w-75 bg-white rounded p-3 border border-secondary-500 container'>
