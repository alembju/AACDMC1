...
const getImage = async (imageid) => {
  const result = await axios.get(`${BASE_URL}/get-imageID`)
  console.log(result)
 ...
 <div className={index===0 ? "carousel-item active ":"carousel-item"}  key={retbanner._id}>
    ...
    />
        ...
        <div class="float-lg-right  p-2 mb-2 ">
          ...
          <h4><LuArrowBigRight /><strong>Mission :</strong></h4>
                  <p>“ሁሉ አቀፍ ፍትሃዊና የላቀ ጥራት ያለው አገልግሎትን በማቅረብና ቁጥጥር በማድረግ የህብረተሰቡን ጤና ማበልፀግ”</p>
                  <h4><LuArrowBigRight /> <strong>Vision :</strong></h4>
                  <p>To see healthy, productive and prosperous Addis Ababa.</p>
                  <h4><LuArrowBigRight /><strong>Objectives</strong></h4>
