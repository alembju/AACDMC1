...
export default function TabsPage() {
  ...
  axios.post(`${BASE_URL}/file-Request`,formData)
...
const [options,setOptions]=useState()
 ...
 useEffect(()=>{
  fetch(`${BASE_URL}/fetching-option`)
  .then((data)=>data.json())
        ...
        <div className="Scrol-Agreement"> <p className="Agreement">Terms and conditions
             ...
             <div className="form-check-inline"> <input type='checkbox' checked={isCheked} value={"Agreed"} onChange={handleCheckboxChange} />Agreed</div> <br />
              <div>
                ...
                <NavLink to='/3'><button className='btn btn-info border w-15 bg-primary rounded-3 text-decoration-none' onClick={goBack} ><h5>Previous</h5></button></NavLink>
