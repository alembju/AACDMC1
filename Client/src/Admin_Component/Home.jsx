...
function Home() {
  ...
  useEffect(() => {
   ...
   const getAllMeseales = () => {
    fetch(`${BASE_URL}/getAllUserH?search=${searchQuery}`, {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  //fetching all Login
  const getAllUser = () => {
    fetch(`${BASE_URL}/USERS?search=${searchQuery}`, {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const getAllUserRequest = () => {
    fetch(`${BASE_URL}/DatatRequest?search=${searchQuery}`, {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
...
const getAllreserch = () => {
  fetch(`${BASE_URL}/Masters?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
const getAlluser = () => {
  fetch(`${BASE_URL}/Gete-User?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all cholera
const getAllAdmin = () => {
  fetch(`${BASE_URL}/Gete-Admin?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all cholera
const getAllHFPhem = () => {
  fetch(`${BASE_URL}/Gete-HFPhem?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
const getAllRegionalPhem = () => {
  fetch(`${BASE_URL}/Gete-RegionalPhem?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all cholera
const getAllReserch= () => {
  fetch(`${BASE_URL}/Gete-Reserch?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all cholera
const getAllIRB= () => {
  fetch(`${BASE_URL}/Gete-IRB?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
const getAllSubCityPhem= () => {
  fetch(`${BASE_URL}/Gete-SubCityPhem?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all cholera
const getAllStudent= () => {
  fetch(`${BASE_URL}/Gete-Student?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
const getAllPHD = () => {
  fetch(`${BASE_URL}/Gete-PHD?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all Measles
const getAllMsc = () => {
  fetch(`${BASE_URL}/Gete-Msc?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
const getAllBacheler = () => {
  fetch(`${BASE_URL}/Gete-Bacheler?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all Measles
const getAllProject = () => {
  fetch(`${BASE_URL}/Gete-Project?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all Measles
const getAllSurvey = () => {
  fetch(`${BASE_URL}/Gete-Survey?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
...
//fetching all Measles
const getAllOther = () => {
  fetch(`${BASE_URL}/Gete-Other?search=${searchQuery}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((data) => {
